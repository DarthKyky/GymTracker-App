    ...
    <div className="min-h-screen bg-carbon-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm animate-slide-up">
        <div className="text-center mb-10">
          ...
          <p className="text-steel-400 text-sm">Start tracking your gains today</p>
        </div>

        <div className="card">
          <h1 className="text-xl font-semibold text-slate-200 mb-6">Create account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input className="input" type="text" placeholder="lifter42" value={form.username} onChange={set('username')} required />
            </div>
            <div>
          ...
          <p className="text-center text-steel-500 text-sm mt-5">
            ...
            <Link to="/login" className="text-volt-400 hover:text-volt-500 font-medium">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
